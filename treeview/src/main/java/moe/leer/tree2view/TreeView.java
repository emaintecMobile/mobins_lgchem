...
public class TreeView extends ListView  {
  ...
  protected boolean isRootVisible = false;
  ...
  private int _countTab = 0;
  private int _positionHolder = -1;
  private Message _massageTap = new Message();
  private OnItemTabListener _onItemTabListener = null;
  ...
  public interface OnItemTabListener {
    void onDoubleTap(AdapterView<?> parent, View view, int position, long id);
    void onSingleTap(AdapterView<?> parent, View view, int position, long id);
  }
  final public void setOnItemTabListener(@Nullable OnItemTabListener listener) {
    _onItemTabListener = listener;
  }
  private Handler _handler = new Handler() {
    ...
    public void handleMessage(Message msg) {
      ...
      switch (msg.what) {
        case SINGLE_TAP:
          _countTab = 0;
          _onItemTabListener.onSingleTap(mParent, mView, mPosition, mId);
          break;
        case DOUBLE_TAP:
          _countTab = 0;
          _onItemTabListener.onDoubleTap(mParent, mView, mPosition, mId);
          break;
      }
    }
  };
  OnItemClickListener mItemClickListener = new OnItemClickListener() {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
      ...
      mPosition = position;
      mId = id;
      if (null != _onItemTabListener) {
        switch (_countTab) {
          case 1:
            if (_positionHolder == position) {
              _countTab++;
              ...
              _handler.sendMessageDelayed(_massageTap, DOUBLE_TAP_DELAY);
            } else {
              _countTab++;
  ...
  public void setOnItemLongClickListener(OnItemLongClickListener listener) {
    ...
    super.setOnItemLongClickListener(new OnItemLongClickListener() {
      ...
      public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
        return selectedListener != null && selectedListener.onTreeItemSelected(view, nodes.get(0), position);
      }
    });
  }
